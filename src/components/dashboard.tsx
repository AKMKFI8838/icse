...
import { BookOpenCheck, BotMessageSquare, History, Lightbulb, BarChart3, Newspaper, BookCopy, Cpu, Flame, Headset, FileText, Mic, MessageSquare, AtSign, Music, Code } from 'lucide-react';
...
const features = [
  ...
  },
  {
   ...
   {
    title: 'Latest News',
    description: 'Stay updated with the latest ICSE announcements. (Coming Soon)',
